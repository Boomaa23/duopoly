...
public class ChanceSpace extends RandomCardSpace {
    ...
    public static final RandomCard[] ALL_CARDS = new RandomCard[] {
            ...
            new RandomCard("Advance to Illinois Avenue. If you pass Go, collect $200.",
                    ActionType.GOTO_SPACE, BoardManager.spaceNameToPosition(SpaceName.ILLINOIS_AVENUE)),
            new RandomCard("Advance to St. Charles Place. If you pass Go, collect $200.",
                    ActionType.GOTO_SPACE, BoardManager.spaceNameToPosition(SpaceName.ST_CHARLES_PLACE)),
            ...
            new RandomCard("Take a trip to Reading Railroad. If you pass Go, collect $200.",
                    ActionType.GOTO_SPACE, BoardManager.spaceNameToPosition(SpaceName.READING_RAILROAD)),
            new RandomCard("Advance to Boardwalk.", ActionType.GOTO_SPACE,
                    BoardManager.spaceNameToPosition(SpaceName.BOARDWALK)),
    ...
    private ChanceSpace() {
        super(SpaceName.CHANCE, ALL_CARDS);
    }
